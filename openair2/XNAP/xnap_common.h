...
#include "XNAP_DRBsSubjectToStatusTransfer-Item.h" /* Xn code for SN Status tranfer procedures */
#include "XNAP_DRBBStatusTransfer12bitsSN.h" /* Xn code for SN Status tranfer procedures */
#include "XNAP_DRBBStatusTransfer18bitsSN.h" /* Xn code for SN Status tranfer procedures */
