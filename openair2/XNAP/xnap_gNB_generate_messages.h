...
int xnap_gNB_generate_sn_status_transfer(sctp_assoc_t assoc_id, xnap_sn_status_transfer_t *xnap_sn_status_transfer); /* Xn code for SN Status transfer procedures*/ 
