...
/* XNAP -> rrc layer*/
MESSAGE_DEF(XNAP_LOST_CONNECTION, MESSAGE_PRIORITY_MED, xnap_lost_connection_t, xnap_lost_connection)
...
MESSAGE_DEF(XNAP_HANDOVER_PREPARATION_FAILURE, MESSAGE_PRIORITY_MED, xnap_handover_preparation_failure_t, xnap_handover_preparation_failure)
...
MESSAGE_DEF(XNAP_SN_STATUS_TRANSFER,MESSAGE_PRIORITY_MED,xnap_sn_status_transfer_t, xnap_sn_status_transfer) /* Xn code for SN Status transfer procedures */
